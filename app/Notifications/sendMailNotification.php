...
class sendMailNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ...
                    ->line('Bonjour')
                    ->line('Votre compte a été crée avec succès sur la plateforme de gestion de salaire et employé')
                    ->line('Cliquez sur le bouton ci-dessous pour valider votre compte')
                    ->line('Saisissez le code'.' '.$this->code.' '.'et renseigner le dans le formulaire qui apparaîtra')
