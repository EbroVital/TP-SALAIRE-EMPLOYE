    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">Emp{{$fullPaymentInfo->employe->id}}</div>
            </div>
            <div class="item">
                <div class="label">Nom & prénom:</div>
                <div class="value">{{$fullPaymentInfo->employe->nom}}
                    {{$fullPaymentInfo->employe->prenom}} ({{$fullPaymentInfo->employe->email}})
                </div>
            </div>
            <div class="item">
            ...
            <div class="transaction_details_box">
                ...
                <div class="right">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>{{date('d-m-Y', strtotime($fullPaymentInfo->lauch_date))}}</td>
                                <td>{{$fullPaymentInfo->amount}} FCFA</td>
                            </tr>
                            <tr>
                                <td colspan="2">
